...
add_action("widgets_init", function(){
    register_widget('\adamschoenemann\CollapsiblePagesWidget');
});
...
add_action('admin_enqueue_scripts', function ($hook) {
    ...
    // optionally, add custom stylesheet for admin-widget interface
